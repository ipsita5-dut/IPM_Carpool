...
registerForm.addEventListener('submit', (e) => {
    ...
    const isAvailableNextday = document.getElementById('isAvailableNextday').value === 'true'; // Get the value from dropdown
    ...
    formData.append('isAvailableNextday', isAvailableNextday);
